...
def main():
    ...
    optG = torch.optim.Adam(netG.parameters(), lr=1e-8, betas=(0.5, 0.9))
    ...
    print("Dataset Loaded, train: {}, test: {}".format(len(train_set)//args.batch_size,len(test_set)//args.batch_size))
